...
$query="INSERT into usuarios(nombre,correo)values('".$_POST["nombreF"]."','".$_POST["correoF"]."')";
...
$query="insert into pedidos (id_usuario,id_producto,precio,cantidad)values(".$id_usuario.",".$id_producto.",".$precio.",".$cantidad.")";
